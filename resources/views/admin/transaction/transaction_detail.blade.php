                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex flex-column justify-content-evenly align-items-start">
                                            <h5 class="card-title">{{ $transactionDetail->name ?? 'Produk tidak ditemukan' }}</h5>
                                            <p class="text-danger fs-5 my-0">@currency($transactionDetail->price)</p>
                                        </div>
                                    </td>
                                    ...
                                    <td style="vertical-align:middle;text-align:right;">
                                        <p class="fs-4 my-0">@currency(($transactionDetail->amount * $transactionDetail->price))</p>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
